...
document.addEventListener("DOMContentLoaded", function () {
  ...
  async function fetchUsers() {
    fetch("http://192.168.1.180/SENA/2613934/08-11-2024/Jeimy_Tatiana_Pinto_Tapia/server_usuario.php", {
      method: "POST",
      headers: {
  ...
  async function saveUser(formData) {
    try {
      const response = await fetch("http://192.168.1.180/SENA/2613934/08-11-2024/Jeimy_Tatiana_Pinto_Tapia/server_usuario.php", {
        method: "POST",
